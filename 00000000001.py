...
print(tokenizer.decode(model.generate(**tokenizer("You are an evaluator. Respond ONLY in valid JSON following this structure:\n{\"Rating\": <integer between 1 and 5>, \"Explanation\": \"<1-2 short sentences>\"}\n\nExample 1:\nTranscript: The customer asked for a refund and the agent explained the process clearly.\nSummary: The agent guided the customer properly through the refund process.\nResponse: {\"Rating\": 5, \"Explanation\": \"Clear and concise explanation of the process.\"}\n\nExample 2:\nTranscript: The agent ignored the customer's concern and ended the chat abruptly.\nSummary: The agent did not address the customer's issue.\nResponse: {\"Rating\": 2, \"Explanation\": \"Poor engagement and unresolved concern.\"}\n\nNow evaluate the following conversation:\nTranscript:\nPaul Merson has restarted his row with Andros Townsend after the Tottenham midfielder was brought on with only seven minutes remaining in his team's 0-0 draw with Burnley on Sunday. 'Just been watching the game, did you miss the coach? #RubberDub #7minutes,' Merson put on Twitter. Merson initially angered Townsend for writing in his Sky Sports column that 'if Andros Townsend can get in (the England team) then it opens it up to anybody.' Paul Merson had another dig at Andros Townsend after his appearance for Tottenham against Burnley. Townsend was brought on in the 83rd minute for Tottenham as they drew 0-0 against Burnley. Andros Townsend scored England's equaliser in their 1-1 friendly draw with Italy in Turin on Tuesday night. The former Arsenal man was proven wrong when Townsend hit a stunning equaliser for England against Italy and he duly admitted his mistake. 'It's not as though I was watching hoping he wouldn't score for England, I'm genuinely pleased for him and fair play to him – it was a great goal,' Merson said. 'It's just a matter of opinion, and my opinion was that he got pulled off after half an hour at Manchester United in front of Roy Hodgson, so he shouldn't have been in the squad. When I'm wrong, I hold my hands up. I don't have a problem with doing that – I'll always be the first to admit when I'm wrong.' Townsend hit back at Merson on Twitter after scoring for England against Italy. Sky Sports pundit Merson criticised Townsend's call-up to the England squad last week. Townsend hit back at Merson after netting for England in Turin on Wednesday, saying 'Not bad for a player that should be nowhere near the squad @PaulMerse?' Any bad feeling between the pair seemed to have passed, but Merson was unable to resist having another dig at Townsend after Tottenham drew at Turf Moor.\n\nSummary:\nHe was unable to find a winner as the game ended without a goal. Townsend had clashed with Paul Merson last week over England call-up.\n\nNow reply ONLY in valid JSON with Rating and Explanation:", return_tensors='pt').to(model.device), max_new_tokens=200, do_sample=False, temperature=0.2, eos_token_id=tokenizer.eos_token_id, pad_token_id=tokenizer.eos_token_id, forced_bos_token_id=tokenizer("{\"Rating\":")["input_ids"][0])[0], skip_special_tokens=True))

# Example repeated
print(tokenizer.decode(model.generate(**tokenizer("Transcript:\nPaul Merson has restarted his row with Andros Townsend after the Tottenham midfielder was brought on with only seven minutes remaining in his team's 0-0 draw with Burnley on Sunday. 'Just been watching the game, did you miss the coach? #RubberDub #7minutes,' Merson put on Twitter. Merson initially angered Townsend for writing in his Sky Sports column that 'if Andros Townsend can get in (the England team) then it opens it up to anybody.' Paul Merson had another dig at Andros Townsend after his appearance for Tottenham against Burnley. Townsend was brought on in the 83rd minute for Tottenham as they drew 0-0 against Burnley. Andros Townsend scored England's equaliser in their 1-1 friendly draw with Italy in Turin on Tuesday night. The former Arsenal man was proven wrong when Townsend hit a stunning equaliser for England against Italy and he duly admitted his mistake. 'It's not as though I was watching hoping he wouldn't score for England, I'm genuinely pleased for him and fair play to him – it was a great goal,' Merson said. 'It's just a matter of opinion, and my opinion was that he got pulled off after half an hour at Manchester United in front of Roy Hodgson, so he shouldn't have been in the squad. When I'm wrong, I hold my hands up. I don't have a problem with doing that – I'll always be the first to admit when I'm wrong.' Townsend hit back at Merson on Twitter after scoring for England against Italy. Sky Sports pundit Merson criticised Townsend's call-up to the England squad last week. Townsend hit back at Merson after netting for England in Turin on Wednesday, saying 'Not bad for a player that should be nowhere near the squad @PaulMerse?' Any bad feeling between the pair seemed to have passed, but Merson was unable to resist having another dig at Townsend after Tottenham drew at Turf Moor.\n\nSummary:\nHe was unable to find a winner as the game ended without a goal. Townsend had clashed with Paul Merson last week over England call-up.\n\nNow reply ONLY in valid JSON following this structure:\n{\"Rating\": <integer between 1 and 5>, \"Explanation\": \"<1-2 short sentences>\"}\nExample: {\"Rating\": 4, \"Explanation\": \"The summary captures the main points but misses context on the argument.\"}\nDo NOT include any text before or after the JSON.\nBegin your response with '{' and nothing else. Respond strictly in this JSON format only.", return_tensors='pt').to(model.device), max_new_tokens=180, do_sample=False, temperature=0.0, eos_token_id=tokenizer.eos_token_id, pad_token_id=tokenizer.eos_token_id, forced_bos_token_id=tokenizer("{\"Rating\":")["input_ids"][0])[0], skip_special_tokens=True))

# Not working
print(tokenizer.decode(model.generate(**tokenizer("Transcript:\nPaul Merson has restarted his row with Andros Townsend after the Tottenham midfielder was brought on with only seven minutes remaining in his team's 0-0 draw with Burnley on Sunday. 'Just been watching the game, did you miss the coach? #RubberDub #7minutes,' Merson put on Twitter. Merson initially angered Townsend for writing in his Sky Sports column that 'if Andros Townsend can get in (the England team) then it opens it up to anybody.' Paul Merson had another dig at Andros Townsend after his appearance for Tottenham against Burnley. Townsend was brought on in the 83rd minute for Tottenham as they drew 0-0 against Burnley. Andros Townsend scored England's equaliser in their 1-1 friendly draw with Italy in Turin on Tuesday night. The former Arsenal man was proven wrong when Townsend hit a stunning equaliser for England against Italy and he duly admitted his mistake. 'It's not as though I was watching hoping he wouldn't score for England, I'm genuinely pleased for him and fair play to him – it was a great goal,' Merson said. 'It's just a matter of opinion, and my opinion was that he got pulled off after half an hour at Manchester United in front of Roy Hodgson, so he shouldn't have been in the squad. When I'm wrong, I hold my hands up. I don't have a problem with doing that – I'll always be the first to admit when I'm wrong.' Townsend hit back at Merson on Twitter after scoring for England against Italy. Sky Sports pundit Merson criticised Townsend's call-up to the England squad last week. Townsend hit back at Merson after netting for England in Turin on Wednesday, saying 'Not bad for a player that should be nowhere near the squad @PaulMerse?' Any bad feeling between the pair seemed to have passed, but Merson was unable to resist having another dig at Townsend after Tottenham drew at Turf Moor.\n\nSummary:\nHe was unable to find a winner as the game ended without a goal. Townsend had clashed with Paul Merson last week over England call-up.\n\nNow reply ONLY in valid JSON following this structure:\n{\"Rating\": <integer between 1 and 5>, \"Explanation\": \"<1-2 short sentences>\"}\nDo NOT include any text before or after the JSON.\nBegin your response with '{' and nothing else. Respond strictly in this JSON format only.", return_tensors='pt').to(model.device), max_new_tokens=180, do_sample=False, temperature=0.0, eos_token_id=tokenizer.eos_token_id, pad_token_id=tokenizer.eos_token_id)[0], skip_special_tokens=True))


print(tokenizer.decode(model.generate(**tokenizer("Transcript:\nPaul Merson has restarted his row with Andros Townsend after the Tottenham midfielder was brought on with only seven minutes remaining in his team's 0-0 draw with Burnley on Sunday. 'Just been watching the game, did you miss the coach? #RubberDub #7minutes,' Merson put on Twitter. Merson initially angered Townsend for writing in his Sky Sports column that 'if Andros Townsend can get in (the England team) then it opens it up to anybody.' Paul Merson had another dig at Andros Townsend after his appearance for Tottenham against Burnley. Townsend was brought on in the 83rd minute for Tottenham as they drew 0-0 against Burnley. Andros Townsend scored England's equaliser in their 1-1 friendly draw with Italy in Turin on Tuesday night. The former Arsenal man was proven wrong when Townsend hit a stunning equaliser for England against Italy and he duly admitted his mistake. 'It's not as though I was watching hoping he wouldn't score for England, I'm genuinely pleased for him and fair play to him – it was a great goal,' Merson said. 'It's just a matter of opinion, and my opinion was that he got pulled off after half an hour at Manchester United in front of Roy Hodgson, so he shouldn't have been in the squad. When I'm wrong, I hold my hands up. I don't have a problem with doing that – I'll always be the first to admit when I'm wrong.' Townsend hit back at Merson on Twitter after scoring for England against Italy. Sky Sports pundit Merson criticised Townsend's call-up to the England squad last week. Townsend hit back at Merson after netting for England in Turin on Wednesday, saying 'Not bad for a player that should be nowhere near the squad @PaulMerse?' Any bad feeling between the pair seemed to have passed, but Merson was unable to resist having another dig at Townsend after Tottenham drew at Turf Moor.\n\nSummary:\nAndros Townsend, an 83rd minute sub in Tottenham's draw with Burnley, was unable to find a winner as the game ended without a goal. Townsend had clashed with Paul Merson last week over England call-up.\n\nNow reply ONLY in valid JSON following this structure:\n{\"Rating\": <integer between 1 and 5>, \"Explanation\": \"<1-2 short sentences>\"}\nDo NOT include any text before or after the JSON.\nBegin your response with '{' and nothing else. Respond strictly in this JSON format only.", return_tensors='pt').to(model.device), max_new_tokens=180, do_sample=False, temperature=0.0, eos_token_id=tokenizer.eos_token_id, pad_token_id=tokenizer.eos_token_id)[0], skip_special_tokens=True))


print(tokenizer.decode(model.generate(**tokenizer("Transcript:\nPaul Merson has restarted his row with Andros Townsend after the Tottenham midfielder was brought on with only seven minutes remaining in his team's 0-0 draw with Burnley on Sunday. 'Just been watching the game, did you miss the coach? #RubberDub #7minutes,' Merson put on Twitter. Merson initially angered Townsend for writing in his Sky Sports column that 'if Andros Townsend can get in (the England team) then it opens it up to anybody.' Paul Merson had another dig at Andros Townsend after his appearance for Tottenham against Burnley. Townsend was brought on in the 83rd minute for Tottenham as they drew 0-0 against Burnley. Andros Townsend scored England's equaliser in their 1-1 friendly draw with Italy in Turin on Tuesday night. The former Arsenal man was proven wrong when Townsend hit a stunning equaliser for England against Italy and he duly admitted his mistake. 'It's not as though I was watching hoping he wouldn't score for England, I'm genuinely pleased for him and fair play to him – it was a great goal,' Merson said. 'It's just a matter of opinion, and my opinion was that he got pulled off after half an hour at Manchester United in front of Roy Hodgson, so he shouldn't have been in the squad. When I'm wrong, I hold my hands up. I don't have a problem with doing that – I'll always be the first to admit when I'm wrong.' Townsend hit back at Merson on Twitter after scoring for England against Italy. Sky Sports pundit Merson criticised Townsend's call-up to the England squad last week. Townsend hit back at Merson after netting for England in Turin on Wednesday, saying 'Not bad for a player that should be nowhere near the squad @PaulMerse?' Any bad feeling between the pair seemed to have passed, but Merson was unable to resist having another dig at Townsend after Tottenham drew at Turf Moor.\n\nSummary:\nAndros Townsend, an 83rd minute sub in Tottenham's draw with Burnley, was unable to find a winner as the game ended without a goal. Townsend had clashed with Paul Merson last week over England call-up.\n\nNow reply ONLY in valid JSON following this structure:\n{\"Rating\": <integer between 1 and 5>, \"Explanation\": \"<1-2 short sentences>\"}\nDo NOT include any other text before or after the JSON.\nRespond strictly in this JSON format only.", return_tensors='pt').to(model.device), max_new_tokens=200, do_sample=False, temperature=0.0, eos_token_id=tokenizer.eos_token_id, pad_token_id=tokenizer.eos_token_id)[0], skip_special_tokens=True))




print(tokenizer.decode(model.generate(**tokenizer("Transcript:\nAgent: Good morning, thank you for contacting our support desk. How may I help you today?\nCustomer: Hi, my mobile banking app keeps crashing when I try to transfer money.\nAgent: I’m sorry for the inconvenience. Could you tell me which version of the app you’re using?\nCustomer: I’m not sure, but I just updated it yesterday.\nAgent: Thanks. I’ll check for known issues. Meanwhile, please try reinstalling the app and restarting your phone.\nCustomer: Okay, I’ll do that. Will I lose my saved payees if I reinstall?\nAgent: No, your payees are stored in the cloud, so you won’t lose them. Try it and let me know if it works.\nCustomer: Alright, it’s working now. Thank you!\n\nSummary:\nThe agent guided the customer to resolve the app crash issue by suggesting troubleshooting steps, which successfully fixed the problem.\n\nNow reply ONLY in valid JSON following this structure:\n{\"Rating\": <integer between 1 and 5>, \"Explanation\": \"<1-2 short sentences>\"}\nDo NOT include any other text before or after the JSON.\nRespond strictly in this JSON format only.", return_tensors='pt').to(model.device), max_new_tokens=160, do_sample=False, temperature=0.0, eos_token_id=tokenizer.eos_token_id, pad_token_id=tokenizer.eos_token_id)[0], skip_special_tokens=True))
...
print(tokenizer.decode(model.generate(**tokenizer("You are an evaluator. Respond ONLY in this strict JSON format:\n{\"Rating\": <integer between 1 and 5>, \"Explanation\": \"<1-2 short sentences>\"}\nDo not include anything else — no text outside JSON.\n\nTranscript:\nAgent: Thank you for calling, how may I help you?\nCustomer: I want to reset my password.\n\nSummary:\nThe agent greeted the customer and the customer asked to reset their password.\n\nNow produce only a valid JSON object:\n", return_tensors='pt').to(model.device), max_new_tokens=120, do_sample=False, temperature=0.0, repetition_penalty=1.2, eos_token_id=tokenizer.eos_token_id, pad_token_id=tokenizer.eos_token_id)[0], skip_special_tokens=True))


print(tokenizer.decode(model.generate(
    **tokenizer(
        "You are an evaluator. Respond ONLY in this strict JSON format:\n"
        '{"Rating": <integer between 1 and 5>, "Explanation": "<1-2 short sentences>"}\n'
        "Do not include anything else — no text outside JSON.\n\n"
        "Transcript:\n"
        "Agent: Thank you for calling, how may I help you?\n"
...
print(tokenizer.decode(model.generate(**tokenizer("You are an evaluator. Respond ONLY in this format:\nRating: <digit 1–5>\nExplanation: <1–2 sentences>\nDo NOT add anything else.\n\nTranscript:\nAgent: Thank you for calling, how may I help you?\nCustomer: I want to reset my password.\n\nSummary:\nThe agent greeted the customer and the customer asked to reset their password.\n\nNow reply strictly in the requested format:", return_tensors="pt").to(model.device), max_new_tokens=80, do_sample=False, temperature=0.0, eos_token_id=tokenizer.eos_token_id, pad_token_id=tokenizer.eos_token_id)[0], skip_special_tokens=True))
...
print("\n".join(tokenizer.decode(model.generate(tokenizer.apply_chat_template([{"role":"system","content":"You are an evaluator. Respond ONLY with exactly two lines:\nRating: <digit 1-5>\nExplanation: <1-2 sentences>\nDo not repeat transcript, summary, or add extra text."},{"role":"user","content":"Transcript:\nAgent: Good morning, thank you for contacting us. How may I assist you today?\nCustomer: I’ve been locked out of my account since last night.\nAgent: I see, could you please confirm your registered email address?\nCustomer: Yes, it’s user@example.com\nAgent: Thank you. I’ve reset your access and sent a new temporary password to your email. Please try logging in again.\nCustomer: Got it, I’ll check. Yes, it works now. Thanks a lot!\nSummary:\nThe agent helped the customer regain account access successfully."}], tokenize=True, add_generation_prompt=True, return_tensors="pt").to("cuda" if torch.cuda.is_available() else "cpu"), max_new_tokens=80, do_sample=False, temperature=0.0, eos_token_id=tokenizer.eos_token_id, pad_token_id=tokenizer.eos_token_id)[0], skip_special_tokens=True).splitlines()[:2]))



print(tokenizer.decode(model.generate(tokenizer.apply_chat_template([{"role":"system","content":"You are an evaluator. Respond ONLY in this exact format:\nRating: <digit 1-5>\nExplanation: <1-2 sentences>"},{"role":"user","content":"Transcript:\nAgent: Good morning, thank you for contacting us. How may I assist you today?\nCustomer: I’ve been locked out of my account since last night.\nAgent: I see, could you please confirm your registered email address?\nCustomer: Yes, it’s user@example.com\nAgent: Thank you. I’ve reset your access and sent a new temporary password to your email. Please try logging in again.\nCustomer: Got it, I’ll check. Yes, it works now. Thanks a lot!\nSummary:\nThe agent helped the customer regain account access successfully."}], tokenize=True, add_generation_prompt=True, return_tensors="pt").to("cuda" if torch.cuda.is_available() else "cpu"), max_new_tokens=60, do_sample=False, temperature=0.0, eos_token_id=tokenizer.eos_token_id, pad_token_id=tokenizer.eos_token_id)[0], skip_special_tokens=True).strip())


#### Rating:1 with explanation but without placeholder
import torch; prompt=tokenizer.apply_chat_template([{"role":"system","content":"You are an evaluator. Respond ONLY in this exact format:\nRating: <digit 1-5>\nExplanation: <1-2 sentences>"},{"role":"user","content":"Transcript:\nAgent: Thank you for calling, how can I help?\nCustomer: I am unable to access my account.\n\nSummary:\nThe customer reported login issues and asked for support."}], tokenize=True, add_generation_prompt=True, return_tensors="pt").to("cuda" if torch.cuda.is_available() else "cpu"); out=model.generate(prompt, max_new_tokens=60, do_sample=False, temperature=0.0, eos_token_id=tokenizer.eos_token_id, pad_token_id=tokenizer.eos_token_id); print(tokenizer.decode(out[0], skip_special_tokens=True))

import torch; inputs=tokenizer.apply_chat_template([{"role":"system","content":"You are an evaluator. Respond ONLY in this exact format:\nRating: <digit 1-5>\nExplanation: <1-2 sentences>"},{"role":"user","content":"Transcript:\nAgent: Thank you for calling, how can I help?\nCustomer: I am unable to access my account.\n\nSummary:\nThe customer reported login issues and asked for support."}], return_tensors="pt").to("cuda" if torch.cuda.is_available() else "cpu"); out=model.generate(inputs, max_new_tokens=60, do_sample=False, temperature=0.0, eos_token_id=tokenizer.eos_token_id, pad_token_id=tokenizer.eos_token_id); print(tokenizer.decode(out[0], skip_special_tokens=True))
...
import torch; prompt="You are an evaluator. Respond ONLY in this format:\nRating: <digit 1-5>\nExplanation: <1-2 sentences>\n\nTranscript:\nAgent: Thank you for calling, how can I help?\nCustomer: I am unable to access my account.\n\nSummary:\nThe customer reported login issues and asked for support."; inputs=tokenizer(prompt, return_tensors="pt").to("cuda" if torch.cuda.is_available() else "cpu"); out=model.generate(**inputs, max_new_tokens=60, do_sample=False, temperature=0.0, eos_token_id=tokenizer.eos_token_id, pad_token_id=tokenizer.eos_token_id); resp=tokenizer.decode(out[0][inputs['input_ids'].shape[1]:], skip_special_tokens=True).strip(); lines=[l for l in resp.splitlines() if l.strip().startswith("Rating:") or l.strip().startswith("Explanation:")]; print("=== RAW OUTPUT ===\n"+"\n".join(lines[:2]))



import torch; prompt="You are an evaluator. Respond ONLY in this exact format:\nRating: <digit 1-5>\nExplanation: <1-2 sentences>\n\nTranscript:\nAgent: Thank you for calling, how can I help?\nCustomer: I am unable to access my account.\n\nSummary:\nThe customer reported login issues and asked for support."; inputs=tokenizer(prompt, return_tensors="pt").to("cuda" if torch.cuda.is_available() else "cpu"); forced=tokenizer("Rating:", return_tensors="pt").to(inputs.input_ids.device); out=model.generate(input_ids=torch.cat([inputs.input_ids, forced.input_ids[:,1:]], dim=1), attention_mask=torch.cat([inputs.attention_mask, forced.attention_mask[:,1:]], dim=1), max_new_tokens=50, do_sample=False, temperature=0.0, eos_token_id=tokenizer.eos_token_id, pad_token_id=tokenizer.eos_token_id); resp=tokenizer.decode(out[0][inputs['input_ids'].shape[1]:], skip_special_tokens=True).strip(); print("=== RAW OUTPUT ===\nRating:"+resp)
...
import torch; prompt="You are an evaluator. Respond ONLY in this exact format with two lines:\nRating: <digit 1-5>\nExplanation: <1-2 sentences>\n\nNow respond for this case:\nTranscript:\nAgent: Thank you for calling, how can I help?\nCustomer: I am unable to access my account.\n\nSummary:\nThe customer reported login issues and asked for support.\n\nBegin your answer directly with 'Rating:'"; inputs=tokenizer(prompt, return_tensors="pt").to("cuda" if torch.cuda.is_available() else "cpu"); out=model.generate(**inputs, max_new_tokens=80, do_sample=False, temperature=0.0, eos_token_id=None, pad_token_id=tokenizer.eos_token_id); print("\n=== RAW OUTPUT ===\n"+tokenizer.decode(out[0][inputs['input_ids'].shape[1]:], skip_special_tokens=True).strip())
#########
import torch; prompt="You are an evaluator. Respond ONLY in this exact format:\nRating: <digit 1-5>\nExplanation: <1-2 sentences>\n\nExample:\nRating: <digit>\nExplanation: <short sentence>\n\nNow respond for this case:\nTranscript:\nAgent: Thank you for calling, how can I help?\nCustomer: I am unable to access my account.\n\nSummary:\nThe customer reported login issues and asked for support."; inputs=tokenizer(prompt, return_tensors="pt").to("cuda" if torch.cuda.is_available() else "cpu"); out=model.generate(**inputs, max_new_tokens=60, do_sample=False, temperature=0.0, eos_token_id=tokenizer.eos_token_id, pad_token_id=tokenizer.eos_token_id); print("\n=== RAW OUTPUT ===\n"+tokenizer.decode(out[0][inputs['input_ids'].shape[1]:], skip_special_tokens=True).strip())
...
import torch; prompt="You are an evaluator. Respond ONLY in this exact format and nothing else:\nRating: <digit 1-5>\nExplanation: <1-2 sentences>\n\nDO NOT output transcript or summary. DO NOT repeat input.\n\nTranscript:\nAgent: Thank you for calling, how can I help?\nCustomer: I am unable to access my account.\n\nSummary:\nThe customer reported login issues and asked for support."; inputs=tokenizer(prompt, return_tensors="pt").to("cuda" if torch.cuda.is_available() else "cpu"); out=model.generate(**inputs, max_new_tokens=40, do_sample=False, temperature=0.0, eos_token_id=tokenizer.eos_token_id, pad_token_id=tokenizer.eos_token_id); print("\n=== RAW OUTPUT ===\n"+tokenizer.decode(out[0][inputs['input_ids'].shape[1]:], skip_special_tokens=True).strip())


import torch; prompt="You are an evaluator. Respond ONLY in this exact format and nothing else:\nRating: <digit 1-5>\nExplanation: <1-2 sentences>\n\nTranscript:\nAgent: Thank you for calling, how can I help?\nCustomer: I am unable to access my account.\n\nSummary:\nThe customer reported login issues and asked for support."; inputs=tokenizer(prompt, return_tensors="pt").to("cuda" if torch.cuda.is_available() else "cpu"); out=model.generate(**inputs, max_new_tokens=80, do_sample=False, temperature=0.0, eos_token_id=tokenizer.eos_token_id, pad_token_id=tokenizer.eos_token_id); print("\n=== RAW OUTPUT ===\n"+tokenizer.decode(out[0][inputs['input_ids'].shape[1]:], skip_special_tokens=True).strip())
